...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    offline = args.offline or not args.cross_check
    if not offline:
        console.print("[dim]Canlı kaynaklardan boyut doğrulaması alınıyor...[/dim]")
    candidates = build_catalog(offline=offline, cross_check=args.cross_check)
